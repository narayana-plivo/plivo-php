...
class BrandTest extends BaseTestCase {
    ...
    public function testBrandCreate()
    {
        ...
        $actual = $this->client->brand->create("New York", "ABC Inc.","US", "111111111", "US", "johndoe@abc.com", "PRIVATE_PROFIT", "John", "Doe","+11234567890","10001", "PENDING", "NY", "NASDAQ", "ABC", "123", "RETAIL");
