...
class CampaignInterface extends ResourceInterface
{
    ...
    public function create(
        $brand_id,$campaign_alias,$vertical,$usecase,$sub_usecases,$description,$embedded_link,$embedded_phone,$age_gated,$direct_lending,$subscriber_optin,$subscriber_optout,$subscriber_help,$sample1,$sample2, array $optionalArgs = [])
    {
        $mandaoryArgs = [
            'brand_id' => $brand_id,
