...
class BrandInterface extends ResourceInterface
{
    ...
    *  @param {object} params 
    ...
    public function create(
        $city,$company_name,$country,$ein,$ein_issuing_country,$email,$entity_type,$phone,$postal_code,$registration_status,$state,$stock_exchange,$stock_symbol,$street,$vertical, array $optionalArgs = [])
    {
        $mandaoryArgs = [
            'city' => $city,
